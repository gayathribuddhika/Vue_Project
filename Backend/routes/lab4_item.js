...
const Item = require("../models/lab4_itemdetails")
router.use(cors())
...
router.delete('/lab4/delete/:id', function (req, res) {               //can also use findByIdAndRemove
...
router.post('/lab4/update/:id', function (req, res) {
