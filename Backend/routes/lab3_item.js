...
const Item = require("../models/lab3_item.model")
router.use(cors())
...
router.put('/lab3/update/:id', function (req, res) {
...
router.delete('/lab3/delete/:id', function (req, res) {               //can also use findByIdAndRemove
