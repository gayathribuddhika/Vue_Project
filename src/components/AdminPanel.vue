...
<div>
  ...
  >
    <b-card-body>
      <b-card-title>Admin Name</b-card-title>
    </b-card-body>
    ...
    <b-list-group variant="dark">
      ...
      <b-list-group-item variant="dark" href="#">Change Password</b-list-group-item>
      ...
      <b-list-group-item variant="dark" href="#">Logout</b-list-group-item>
    </b-list-group>
    </b-card>
</div>
</template>